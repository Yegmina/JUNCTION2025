# 📸 Как Экспортировать Диаграммы в Изображения
...
Все диаграммы теперь имеют:
- ✅ **Увеличенный шрифт** (18px)
- ✅ **Компактный дизайн** (меньше пустого пространства)
...
## 🖼️ Метод 1: Скриншот (Самый Простой)
...
## 🖥️ Метод 4: Mermaid CLI (Профессиональный)
